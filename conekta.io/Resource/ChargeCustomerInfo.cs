...
namespace conekta.io.Resource
{
    ...
    /// </summary>
    [DataContract]
    public class ChargeCustomerInfo : IEquatable<ChargeCustomerInfo>
    {


        /// <summary>
        ///     Initializes a new instance of the <see cref="ChargeCustomerInfo" /> class.
        ///     Initializes a new instance of the <see cref="ChargeCustomerInfo" />class.
        /// </summary>
        ...
        public ChargeCustomerInfo(string LoggedIn = null, int? SuccessfulPurchases = null, int? CreatedAt = null,
        ...
        public bool Equals(ChargeCustomerInfo other)
        {
        ...
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            return Equals(obj as ChargeCustomerInfo);
        }
